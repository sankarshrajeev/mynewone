    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    /*// Trying
    mAMAmountSlider.setSliderStyle(juce::Slider::SliderStyle::RotaryVerticalDrag);
    mAMAmountSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, false, 150, 20);
    addAndMakeVisible(mAMAmountSlider);
     */
 ...
 /*   mAMAmountSliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(audioProcessor.getValueTreeState(),
                                                                                             PARAMETER_NAMES[AM_AMOUNT],
                                                                                             mAMAmountSlider));
    */
    setSize(400, 300);
}
...
void CoursePluginAudioProcessorEditor::resized()
{
    ...
    mAMAmountSlider.setBounds(0,150, 150, 150);
}
